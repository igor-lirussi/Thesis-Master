...
% use task parameter chaging capabilities to shift to another meaningful plan if one fails. 
% use task parameter chaging capabilities tp shift among continuous actions, 
% variable functions for transition

% optimization of the graph building, research and pruining
% different time length for concatenation
